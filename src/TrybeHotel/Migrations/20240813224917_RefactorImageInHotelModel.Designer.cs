...
namespace TrybeHotel.Migrations
{
    ...
    [Migration("20240813224917_RefactorImageInHotelModel")]
    partial class RefactorImageInHotelModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TrybeHotel.Models.Booking", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            BookingId = 1,
                            CheckIn = new DateTime(2024, 8, 13, 19, 49, 17, 511, DateTimeKind.Local).AddTicks(3593),
                            CheckOut = new DateTime(2024, 8, 14, 19, 49, 17, 511, DateTimeKind.Local).AddTicks(3622),
                            GuestQuant = 2,
                            RoomId = 1,
                            UserId = 1
                        },
                        ...
                        {
                            BookingId = 2,
                            CheckIn = new DateTime(2024, 8, 13, 19, 49, 17, 511, DateTimeKind.Local).AddTicks(3628),
                            CheckOut = new DateTime(2024, 8, 14, 19, 49, 17, 511, DateTimeKind.Local).AddTicks(3629),
                            GuestQuant = 1,
                            RoomId = 2,
                            UserId = 2
                        });
