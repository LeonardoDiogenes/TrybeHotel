...
namespace TrybeHotel.Migrations
{
    ...
    [Migration("20240802031147_AddImgHotel")]
    partial class AddImgHotel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TrybeHotel.Models.Booking", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            BookingId = 1,
                            CheckIn = new DateTime(2024, 8, 2, 0, 11, 47, 797, DateTimeKind.Local).AddTicks(4323),
                            CheckOut = new DateTime(2024, 8, 3, 0, 11, 47, 797, DateTimeKind.Local).AddTicks(4351),
                            GuestQuant = 2,
                            RoomId = 1,
                            UserId = 1
                        },
                        ...
                        {
                            BookingId = 2,
                            CheckIn = new DateTime(2024, 8, 2, 0, 11, 47, 797, DateTimeKind.Local).AddTicks(4357),
                            CheckOut = new DateTime(2024, 8, 3, 0, 11, 47, 797, DateTimeKind.Local).AddTicks(4358),
                            GuestQuant = 1,
                            RoomId = 2,
                            UserId = 2
                        });
